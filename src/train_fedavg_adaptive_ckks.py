...
def main():
    ...
    for round_idx in range(1, GLOBAL_ROUNDS + 1):
        print(f"\n===== Budgeted Adaptive CKKS FedAvg Round {round_idx}/{GLOBAL_ROUNDS} =====")
    ...
    final_results = {
        "experiment": "EXP-007D",
        "method": "Budgeted Adaptive Selective CKKS Encrypted Aggregation using TenSEAL",
    ...
    print("\nSaved Budgeted Adaptive CKKS FedAvg results to:", RESULTS_DIR)
