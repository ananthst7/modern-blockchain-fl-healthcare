...
CLIENTS_ROOT = Path("data/processed/covid_clients_extreme_noniid_8")
TEST_DIR = Path("data/processed/covid_binary/test")
RESULTS_DIR = Path("results/multikrum_byzantine_8clients")
...
def run_experiment(aggregation_method: str, device):
    ...
    final_results = {
        ...
        "setting": "8 clients, extreme Non-IID + 1 Byzantine sign-flip client",
