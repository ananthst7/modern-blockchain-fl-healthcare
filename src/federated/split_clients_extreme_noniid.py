...
OUTPUT_ROOT = Path("data/processed/covid_clients_extreme_noniid")

SEED = 42

CLIENT_DISTRIBUTION = {
    "client_1": {"COVID": 390, "Normal": 10},
    "client_2": {"COVID": 390, "Normal": 10},
    "client_3": {"COVID": 10, "Normal": 390},
    "client_4": {"COVID": 10, "Normal": 390},
}
